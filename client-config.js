module.exports = {
  ...
  gatsby: {
    siteTitle: 'Academy of Art Spring Show',
    siteDescription: 'Academy of Art University Spring Show',
    siteUrl: 'https://springshow.academyart.edu', // Site domain. Do not include a trailing slash! If you wish to use a path prefix you can read more about that here: https://www.gatsbyjs.org/docs/path-prefix/
